...
public static class AppCatalog
{
    public static readonly AppDefinition[] All = [
        new("refinement", "Macrodata Refinement", "refinement", "Find meaning in the numbers."),
