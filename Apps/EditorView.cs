...
public sealed class EditorView : UserControl
{
    ...
    public EditorView()
    {
        ...
        var status = new Border { Padding = new Thickness(22, 0), Background = Brush.Parse("#18363D"), BorderBrush = Brush.Parse("#35545A"), BorderThickness = new Thickness(0, 1, 0, 0), Child = _status }; Grid.SetRow(status, 4); root.Children.Add(status); Content = root;
